...
export default function AddStation(props) {
    ...
    const updateSt = (polygonStation) => {
        ...
        var sendParams = { ...params, stPolygon: polygonStation, polygonStation }
        console.log("ssssssss333", sendParams)

        AxiosPrivate.put(endpoints.stationsV2, sendParams)
            .then(res => {
                console.log("ssssssss333", sendParams)
                        ...
                        <div className="row g-2 mt-auto ">
                            <div className="col-9">
                                <button className="btn btn-success w-100 "
                                    disabled={sendLock}
                                    onClick={(e) => {
                                        updateSt(params?.polygonStation)
                                        console.log(params)
                                    }}>
                                    ثبت
                                </button>
                    ...
                    <div className="col-12 col-lg-7 d-none d-lg-block bg-danger vh-100">
                        <MapContainer
                            ...
                            <MapController
                                ...
                                polygonStation={params?.polygonStation}
                                ...
                                onPolygonStation={(polygonStation) => {
                                    ...
                                    console.log("ssssssss3323", polygonStation)
                                    updateSt(polygonStation)
                                }}
                                onOtherPolygonClick={(station) => {
                                    console.log("ssssssss3323", stations)
                                    setParams(station)
                                }}
...
function MapController(props) {
    ...
    useEffect(() => {
        // getStations()
        console.log("ssssssssssss", props?.polygonStation)
        // setStations(props?.stations)
                    ...
                    <>
                        <button className="btn btn-success  shadow p-2  m-1"
                            onClick={() => {
                                ...
                                props.onPolygonStation(polygon)
                            }}>
            ...
            <div className=" d-flex">
                <div className=" w-100">
                    ...
                    {addressesResult.length > 0 ?
                        <div className="card overflow-auto aScroll" style={{ height: '15rem', zIndex: 10000 }}>
                            {addressesResult?.map((item, index) => {
                                return <p className="card-hover iranSansBold p-0 m-0 px-2 py-2 noSelect" onClick={() => {
