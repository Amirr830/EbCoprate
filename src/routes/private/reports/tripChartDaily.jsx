...
export default function TripChartDaily() {
    ...
    var initChart = (data) => {
        try {
            ...
            setDataSet({
                ...
                datasets: [
                    {
                        label: 'نمودار میانگین روزانه سفر ها',
                        data: data,
        ...
        <div >
            <div className='row g-2 pb-3 sticky-top  ' style={{ backgroundColor: '#ECEFF1' }}>
                <form className='row col-12 col-md-9 g-2  '>
                    ...
                    <div className='col-6 col-lg-3 '>
                        <label>از تاریخ <span className='text-danger'>*</span></label>
                    ...
                    <div className='col-6 col-lg-3  '>
                        <label>تا تاریخ <span className='text-danger'>*</span></label>
                ...
                {!(params?.fromDate == undefined || params?.toDate == undefined) ?
                    <div className='col-12 col-md-3 row g-2 align-items-end'>
                    ...
                    : <div className='col-12 col-md-3 row g-2 align-items-end'>
                        <div className='col-12'>
                            <button className='col-12 btn btn-warning 'disabled >بازه زمانی را مشخص نمایید</button>
                        </div>
                    </div>
                }
