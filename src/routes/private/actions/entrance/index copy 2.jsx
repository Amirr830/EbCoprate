    ...
    <div className="w-100 vh-100  position-relative d-flex overflow-hidden" dir="rtl">
      <div className="m-0 p-0 d-flex flex-column  col-7 vh-100">
        ...
        <div className="flex-shrink-0">
          <div className="row g-2 p-0 m-0 p-2 pt-0" style={{ background: "#CFD8DC", height: '2.5rem' }}>
        ...
        {/* footer */}
        <div className="d-flex  flex-column h-100 overflow-y-auto overflow-x-hidden ">
          {/* فرم ورود اطلاعات */}
          <div className="p-2  ">
            <form className="g-2 row mx-0 " >
              ...
              <div className="col-6 d-flex align-items-center position-relative" >
                <label className="small opacity-50 " style={{ width: '4rem' }}>مبدا : </label>
                <SearchAddress
              ...
              <div className="col-3 d-flex align-items-center ">
                <label className="small opacity-50 " style={{ width: '4rem' }}>کد راننده : </label>
                <input type="number"
                  onChange={readChange}
              ...
              <div className="col-3 d-flex align-items-center">
                <label className="small opacity-50 " style={{ width: '4rem' }}>نوع مرسوله : </label>
                <input type="number"
                  onChange={readChange}
                  value={params?.driverCode}
                  name="driverCode"
              ...
              <div className="col-3 d-flex align-items-center">
                <label className="small opacity-50 " style={{ width: '4rem' }}>نوع وسیله : </label>
                <input type="number"
                  onChange={readChange}
                  value={params?.driverCode}
                  name="driverCode"
              ...
              <div className="col-3 d-flex align-items-center">
                <label className="small opacity-50 " style={{ width: '4rem' }}>ارزش کالا : </label>
                <input type="number"
                  onChange={readChange}
                  value={params?.driverCode}
                  name="driverCode"
              ...
              <div className="col-3 d-flex align-items-center">
                <label className="small opacity-50 " style={{ width: '4rem' }}>میزان توقف : </label>
                <input type="number"
                  onChange={readChange}
                  value={params?.driverCode}
                  name="driverCode"
              ...
              <div className="col-9 d-flex align-items-center">
                <label className="small opacity-50 " style={{ width: '4rem' }}>توضیحات : </label>
                <input type="number"
                  onChange={readChange}
                  value={params?.driverCode}
                  name="driverCode"
              ...
              <div className="col-12 d-flex align-items-center">
                <label className="small opacity-50 " style={{ width: '4.2rem' }}>'گزینه ها' : </label>
                <div className="d-flex col card border-secondary">
          ...
          <div className="p-3 row g-2   mt-auto" >
            {tripPrice ? <>
