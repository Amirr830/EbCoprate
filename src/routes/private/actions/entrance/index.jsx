...
export default function Entrance() {
  ...
  var insertTrip = (isWithOutDest) => {
    ...
    if (params?.plaque?.replace(' ', '').length < 5) {
      toast.Error("پلاک را صحیح وارد نمایید")
      return
    }
    // console.log('sssssssssssssss', parameters)
  ...
  var [routePath, setRoutePath] = useState([])
              ...
              <form className="g-2 row mx-0 " >
                ...
                <div className="col-4 d-flex align-items-center ">
                  ...
                  <CarPlaqueBox
                    ...
                    onChange={(plaque) => {
                      setParams(
                        prevState => ({ ...prevState, p3: plaque.p3, p2: plaque.p2, pIran: plaque.pIran, ph: plaque.pChar, plaque: plaque.pIran + " - " + plaque.p3 + " " + plaque.pChar + " " + plaque.p2 }))
                    }}>
                ...
                <div className="col-12 d-flex  mt-5" >
                  <div className="col-8 align-items-center">
                    ...
                    <h4 className="text-center col-12 text-danger iranSansBold" title="پورسانت" >
                      {tripPrice?.extraFareLine > 0?
                        tripPrice?.extraFareLineStr :
                        ''}
                    </h4>
