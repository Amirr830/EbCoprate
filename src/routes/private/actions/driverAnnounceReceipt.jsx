...
export default function DriverAnnounceReceipt(props) {
  ...
  var getPaymentList = (reset) => {
    AxiosPrivate.get(endpoints.driverPayment,
      {
        params: {
  ...
  return (
    <>
      <div>
        ...
        <div className="d-flex overflow-auto aScroll noSelect row g-2" >
          ...
          <div className="d-flex pe-2">
            <label className="col-1" style={{ width: '5rem' }}>شماره</label>
            <label className="col-1" style={{ width: '8rem' }}>مبلغ</label>
            <label className="col-1" style={{ width: '6rem' }}>تاریخ ثبت</label>
            <label className="col-1" style={{ width: '6rem' }}>تاریخ واریز</label>
            <label className="col-1" style={{ width: '8rem' }}>راننده</label>
            <label className="col-1" style={{ width: '5rem' }}>کد درخط</label>
            <label className="col-1" style={{ width: '25rem' }}>شرح</label>
            <label className="col-1" style={{ width: '5rem' }}>کد خودرویی</label>
            <label className="col-1" style={{ width: '8rem' }}>پلاک</label>
            <label className="col-1" style={{ width: '8rem' }}>کد سفر</label>
            <label className="col-1" style={{ width: '8rem' }}>نام کاربر</label>
          </div>
          {
            ...
            docs.map((item, index) => {
              return <>
                <Options
                  ...
                  <div key={index} className="overflow-hidden py-2 pe-2 card-success aPointer"
                    style={{ minWidth: '94rem' }}
                  >
                    <div className="d-flex align-items-center ">
                      <label className="col-1 small iranSansBold text-truncate" title={item?.docNo} style={{ width: '5rem' }}>{item?.docNo}</label>
                      ...
                      <label className="col-1 small iranSansBold text-truncate" title={item?.driverName} style={{ width: '8rem' }}>{item?.driverName}</label>
                      <label className="col-1 small iranSansBold" style={{ width: '5rem' }}>{item?.driverCode}</label>
                      <label className="col-1 small text-truncate" title={item?.desc} style={{ width: '25rem' }}>{item?.desc}</label>
