...
export default function UserCard(props) {
    ...
    return (
        <div className={'card p-1 my-2  card-hover '}
            style={{ background: (props?.user?.isArchive == 0 ? '' : '#ff00152f') }}
            key={props?.user?.id}
            ...
            <div className='row align-items-center'>
                ...
                <div className='row col-10'
                    ...
                    <div className=' col-12 col-md-6 col-lg-3 '>
                        ...
                        <a className=" w-100 p-2 m-0 aPointer" href={"tel:" + props?.user?.mobile}>

                            <label className="iranSansBold">
                                {props?.user?.mobile}
                            </label>

                            <MdCall size="20" className='mx-2' />
                        </a>
