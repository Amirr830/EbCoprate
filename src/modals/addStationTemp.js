...
export default function AddStationTemp(props) {
    ...
    const updateSt = () => {
        ...
        AxiosPrivate.put(endpoints.stationsV2, params)
            .then(res => {
    ...
    var stationCheck = () => {
        AxiosPrivate.get(endpoints.stationCheckV2, { params: { stCode: params?.stCode } })
            .then((res) => {
                setMsg(res?.data?.msg)
...
function MapController(props) {
    ...
    var getStations = () => {
        // setLoading(true)
        AxiosPrivate.get(endpoints.stationsV2, {
                ...
                {allowCreatePolygon ?
                    <button className="btn btn-success  shadow p-2  m-1"
                        onClick={() => {
                            ...
                            console.log('ggggggggggggg', polygon)
            ...
            stations?.map((item, index) => {
                return <div key={index} style={{ zIndex: 10000 }}>
                    ...
                    <Polygon
                        ...
                        pathOptions={{ color: 'red', fillColor: 'blue', fillOpacity: 0.1, dashArray: '5, 10' }}
                        eventHandlers={{
                            click: () => {
