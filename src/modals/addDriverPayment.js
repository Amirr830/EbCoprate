...
export default function AddDriverPayment(props) {
    ...
    const addP2D = () => {
        ...
        AxiosPrivate.post(endpoints.driverPayment
        ...
        <Modal show={props.show} onHide={handleClose} centered style={{ background: ' rgba(0, 0, 0, 0.400)' }}>
            ...
            <Modal.Body className="card-header">
                <div className="d-flex  justify-content-end">
                    <h1 className="ps-2 opacity-75 ms-auto me-auto" >دریافت از راننده</h1>
